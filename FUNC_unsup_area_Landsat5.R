...
filename <- dir("E:/Sedimentology/Landsat_files", pattern = "^LT05", full.names = TRUE, ignore.case = TRUE)
...
#Write 
write.table(df.1, file=paste(c("E:/Sedimentology/Landsat_files/","table_landsat5.txt"),collapse=""))
